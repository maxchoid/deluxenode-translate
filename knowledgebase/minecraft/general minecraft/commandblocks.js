...
1. Loggen Sie sich im DeluxeNode-Panel unter https://panel.deluxenode.com/ ein und wählen Sie den Server aus, auf dem Sie die Befehlsblöcke aktivieren möchten.
2. Gehe zum Dateimanager und wähle `server.properties`.
3. Suchen und setzen Sie enable-command-block = auf true.
4. Starten Sie den Server neu.
5. Sie können Befehlsblöcke in Minecraft jetzt mit `/ give <player> command_block` erhalten und benutzen.
